...
#sudo debconf-set-selections <<< 'icinga2-iso-mysql icinga2-ido-mysql/enable yes'
...
#sudo debconf-set-selections <<< 'icinga2-iso-mysql icinga2-ido-mysql/dbconfig-install no'
