...
sudo debconf-set-selections <<< 'icinga-iso-mysql icinga2-ido-mysql/enable true'
...
sudo debconf-set-selections <<< 'icinga-iso-mysql icinga2-ido-mysql/dbconfig-install false'
