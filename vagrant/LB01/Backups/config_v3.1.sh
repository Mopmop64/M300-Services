...
sudo debconf-set-selections <<< 'icinga2-iso-mysql icinga2-ido-mysql/enable true'
...
sudo debconf-set-selections <<< 'icinga2-iso-mysql icinga2-ido-mysql/dbconfig-install false'
